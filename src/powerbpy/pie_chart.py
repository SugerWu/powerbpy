"""Pie chart visual for Power BI dashboards.
This class is used to represent pie charts that can be added to pages.
You should never call this class directly, instead use the add_pie_chart() method attached to the _Page class.
See add_pie_chart() for more details.
"""
...
class _PieChart(_Visual):
    """A pie chart visual type for Power BI."""
    ...
    def __init__(self,
        ...
        # Set visual type
        self.visual_json['visual']['visualType'] = 'pieChart'
        ...
        self.visual_json['visual']['objects'] = {
            ...
            'dataLabels': [
                {
                    'properties': {
                        ...
                        'labelDisplayUnits': {'expr': {'Literal': {'Value': "'Auto'"}}}
                    }
                }
            ],
            'labels': [
                {
                    'properties': {
                        'labelStyle': {'expr': {'Literal': {'Value': "'Outside Base'"}}}
                    }
                }
            ],
            'categoryLabels': [
            ...
            'plotArea': [
                {
                    'properties': {
                        'startAngle': {'expr': {'Literal': {'Value': f'{start_angle}D'}}},
                        'endAngle': {'expr': {'Literal': {'Value': f'{end_angle}D'}}}
                    }
                }
            ]
        }
